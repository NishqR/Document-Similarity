...
if __name__ == "__main__":
    ...
    #test_set=articles_df.sample(frac=1,random_state=200)
    test_set=articles_df.drop(train_set.index)

    
    num_similar_relevant_range = [1,2,3,4,5,10]
    num_similar_irrelevant_range = [1,2,3,4,5,10]
    similarity_threshold_relevant_range = [0.6, 0.7, 0.8, 0.9]
    similarity_threshold_irrelevant_range = [0.6, 0.7, 0.8, 0.9]


    #num_words_relevant_range = list(range(50, 120, 5))
    #num_words_irrelevant_range = list(range(50, 120, 5))
        ...
        for num_similar_irrelevant in num_similar_irrelevant_range:
            ...
            for similarity_threshold_relevant in similarity_threshold_relevant_range:
                for similarity_threshold_irrelevant in similarity_threshold_irrelevant_range:
                    ...
                    eval_dict['frac'] = "variable_rel_irrel_lists"
